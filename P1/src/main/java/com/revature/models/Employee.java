...
public class Employee {
	...
	public Employee(int ers_user_id, String ers_username, String ers_password, String user_first_name,
			String user_last_name, String user_email, int role_id) {
		super();
	...
	public Employee( String user_first_name, String user_last_name,String ers_username, String ers_password,
	...
	public Employee(String ers_username,String user_email) {
		super();
		this.ers_username = ers_username;
		this.user_email = user_email;
	}
	...
	public String toString() {
		return "Employee [ers_user_id=" + ers_user_id + ", ers_username=" + ers_username + ", ers_password="
				...
				+ ", user_email=" + user_email + ", role=" + role_id + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
